...
groceries = []
with open("C:/Users/USER/Downloads/groceries.csv") as f:
    groceries = f.read()
...
frequent_itemsets = apriori(X, min_support=0.005, max_len=3,use_colnames = True) # 989, 2
...
rules = association_rules(frequent_itemsets, metric="lift", min_threshold=1) # 2700, 9 
rules.head(20)
...
# changing the value of support

frequent_itemsets = apriori(X, min_support=0.009, max_len=3,use_colnames = True) # 404, 2
...
rules = association_rules(frequent_itemsets, metric="lift", min_threshold=1) # 796, 9 
rules.head(20)
rules.sort_values('lift',ascending = False).head(10)
